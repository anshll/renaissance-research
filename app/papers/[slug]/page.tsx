...
export default function PaperPage({ params }: PaperPageProps) {
  ...
  const paperLink = link_map[paperId.toString()] ?? "none"; // Fallback to "none" if no link is found
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Nav />
      {/* Main content area */}
      <main className="flex-grow container mx-auto px-4 py-12 max-w-4xl mb-24"> {/* Increased bottom margin */}
      ...
      {/* Fixed Chat Box Footer */}
      <footer className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-gray-200 p-4 z-10">
        {/* Chat History Display */}
        <div ref={chatContainerRef} className="container mx-auto max-w-3xl h-48 overflow-y-auto mb-4 space-y-3 pr-2"> {/* Added height, scroll, spacing */}
        ...
        {/* Chat Input Form */}
        <form onSubmit={handleChatSubmit} className="container mx-auto max-w-3xl flex gap-2">
          <Input
            type="text"
